...
$(function() {
    ...
    $("#alpaca-option-tree-connector").alpaca({
        "schemaSource": "../default/static/demo_data/alpaca/optiontree-custom-schema.json",
        "optionsSource": "../default/static/demo_data/alpaca/optiontree-custom-options.json",
        "options": {
            "focus": false
        }
    });
